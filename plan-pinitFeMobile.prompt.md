...
- [x] 9. “동시에 하나의 일정만 실행” 제약을 고려한 상태/버튼 UX 설계
- [x] 10. 통계 탭(그래프 중심) 레이아웃 및 데이터 모델 설계
- [x] 11. 통계용 도넛/막대 그래프 컴포넌트 및 변환 유틸 설계
- [x] 12. 상단 우측 설정 화면/버튼 설계
- [x] 13. API 클라이언트/에러 처리/에러 메시지 정책
- [x] 14. 프론트 검증 vs 백엔드 검증 책임 분리 원칙 정리
- [x] 15. 날짜/시간 유틸, 주간/일간 포맷터, 파서 설계
- [x] 16. 공통 UI 컴포넌트(TopBar, BottomTabBar, WeeklyDateStrip 등) 설계
- [x] 17. 로딩/에러/비어있는 상태 UX 및 배너/알림 UX 설계
